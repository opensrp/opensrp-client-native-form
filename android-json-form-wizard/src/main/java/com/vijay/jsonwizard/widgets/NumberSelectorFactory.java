...
public class NumberSelectorFactory implements FormWidgetFactory {
    ...
    public static ValidationStatus validate(NativeViewer formFragmentView, CustomTextView customTextView) {
    ...
    @Override
    public List<View> getViewsFromJson(String stepName, Context context, NativeViewer
            formFragment,
    ...
    private List<View> attachJson(String stepName, Context context, NativeViewer formFragment, JSONObject
            jsonObject, CommonListener listener,
    ...
    @SuppressLint("NewApi")
    private void createTextViews(Context context, NativeViewer formFragment, JSONObject jsonObject, LinearLayout
            linearLayout, CommonListener
        ...
        int maxValue = jsonObject.optInt(JsonFormConstants.MAX_SELECTION_VALUE, 20);
        for (int i = 0; i < numberOfSelectors; i++) {
            CustomTextView customTextView = createCustomView(context, formFragment, jsonObject, width, numberOfSelectors, listener,
    ...
    public String getText(int item, int startSelectionNumber, int numberOfSelectors,
                          int maxValue) {
    ...
    @SuppressLint("NewApi")
    private CustomTextView createCustomView(Context context, NativeViewer
            formFragment, JSONObject jsonObject,
                                            int width, int numberOfSelectors,
        ...
        CustomTextView customTextView = FormUtils.getTextViewWith(context, formFragment, Integer.parseInt(textSize), getText(item,
    ...
    private void showSelectedTextView(JSONObject jsonObject, CustomTextView
            customTextView) {
        ...
        public void onReceive(Context contextInner, Intent intent) {
            try {
                ...
                if (jsonObject != null) {
                    ...
                    createTextViews(context, formFragment, jsonObject, rootLayout, listener,
