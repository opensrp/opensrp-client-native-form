...
public class CheckBoxFactory implements FormWidgetFactory {
	...
	private ArrayList<View> addCheckBoxOptionsElements(JSONObject jsonObject, Context context, Boolean readOnly,
		...
		for (int i = 0; i < options.length(); i++) {
			...
			RelativeLayout checkboxLayout =
					(RelativeLayout)LayoutInflater.from(context).inflate(R.layout.native_form_item_checkbox, null);
	 ...
	 */
	private void createCheckBoxText(RelativeLayout checkboxLayout, JSONObject item, Context context, Boolean readOnly)
			throws JSONException {
