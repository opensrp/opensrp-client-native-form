...
public class DatePickerFactory implements FormWidgetFactory {
    ...
    public static final SimpleDateFormat DATE_FORMAT_LOCALE_INDEPENDET = new SimpleDateFormat("dd-MM-yyyy", Locale.ENGLISH);
    ...
    private DatePickerDialog createDateDialog(Context context, final TextView duration, final MaterialEditText editText,
        ...
        datePickerDialog.setOnDateSetListener(new android.app.DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                editText.setTag(R.id.locale_independent_value,  DATE_FORMAT_LOCALE_INDEPENDET.format(calendarDate.getTime()));
