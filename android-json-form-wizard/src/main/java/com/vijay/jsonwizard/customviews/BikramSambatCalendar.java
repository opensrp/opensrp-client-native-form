 ...
 */
public class BikramSambatCalendar extends LinearLayout
    ...
    public BikramSambatCalendar(Context context) {
        this(context, null);
    }


    public BikramSambatCalendar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BikramSambatCalendar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void notifyDateSet() {
        if (mCallback != null) {
            mCallback.onDateClick(BikramSambatCalendar.this,  mCalendar.getYear(),
