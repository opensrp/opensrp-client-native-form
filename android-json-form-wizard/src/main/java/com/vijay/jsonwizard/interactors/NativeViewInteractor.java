...
public class NativeViewInteractor {

    private static final String TAG = "NativeViewInteractor";
    private static final NativeViewInteractor INSTANCE = new NativeViewInteractor();
    protected Map<String, FormWidgetFactory> map = new HashMap<>();

    public NativeViewInteractor() {
        registerWidgets();
    }

    public static NativeViewInteractor getInstance() {
        return INSTANCE;
    }
